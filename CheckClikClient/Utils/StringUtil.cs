...
namespace Customer.Utils
{
    public static class StringUtil
    {
        ...
        public  static string URLEncrypt(string clearText)
        {
            ...
            //string EncryptionKey = "MAKV2SPBNI992912412";
    ...
    public static class StringCipher
    {
        ...
        public static string URLEncrypt(string plainText, string passPhrase="aabbccdd")
        {
        ...
        public static string URLDecrypt(string cipherText, string passPhrase = "aabbccdd")
        {
